(function(){
  function init(){
    ...
    style.textContent=`
      ...
      .bk-landmark-map{position:relative;height:620px;min-height:620px;overflow:hidden;border-radius:0 0 0 42%;isolation:isolate}
      .bk-map-sky{position:absolute;inset:0;background:radial-gradient(circle at 36% 18%,#fff 0 9%,transparent 27%),radial-gradient(circle at 78% 10%,#fff 0 8%,transparent 24%),linear-gradient(180deg,#bfe4fb 0%,#eef8fc 52%,#cfe5c2 100%);z-index:0}
      .bk-map-sky:after{content:"";position:absolute;inset:38% 0 0;background:linear-gradient(180deg,transparent,#a1b991 80%,#819c78);clip-path:polygon(0 48%,18% 35%,38% 49%,58% 30%,77% 42%,100% 22%,100% 100%,0 100%)}
      .bk-city-route{position:absolute;z-index:4;inset:0;width:100%;height:100%;pointer-events:none;overflow:visible}
      .bk-city-route path{fill:none;stroke-linecap:round;stroke-linejoin:round}.bk-route-shadow{stroke:rgba(255,255,255,.95);stroke-width:12}.bk-route-line-main{stroke:#17251b;stroke-width:4;stroke-dasharray:9 10;animation:bkRouteMove 1.7s linear infinite}@keyframes bkRouteMove{to{stroke-dashoffset:-38}}.bk-city-route circle{fill:#fff;stroke:#079447;stroke-width:6}
      .bk-map-title{position:absolute;z-index:12;right:5%;top:4%;font-size:32px;line-height:1.02;font-style:italic;font-weight:900;text-align:right;color:#172019}.bk-map-title span{color:#079447}
      .bk-landmark-card{position:absolute;z-index:11;width:170px;border-radius:15px;background:#fff;box-shadow:0 13px 28px rgba(22,44,26,.16);overflow:hidden;border:2px solid rgba(255,255,255,.98);transition:transform .25s,box-shadow .25s}.bk-landmark-card:hover{transform:translateY(-5px);box-shadow:0 20px 36px rgba(22,44,26,.22)}.bk-landmark-img{display:block;width:100%;height:88px;object-fit:cover;object-position:center}.bk-landmark-label{padding:7px 10px 9px}.bk-landmark-label b{display:block;color:#243128;font-size:11px}.bk-landmark-label small{display:block;color:#68746a;font-size:9px;margin-top:2px}
      .bk-landmark-card.hyd{top:14%;left:19%}.bk-landmark-card.viz{top:40%;left:3%}.bk-landmark-card.vij{top:29%;right:4%}.bk-landmark-card.tir{top:61%;right:17%}.bk-landmark-card.bng{top:68%;left:25%}
      .bk-road-scene{position:absolute;z-index:2;left:0;right:0;bottom:-4px;height:29%;overflow:hidden;pointer-events:none}.bk-road{position:absolute;left:-10%;right:-10%;bottom:-48%;height:105%;background:linear-gradient(180deg,#536256,#27372b);border-radius:50% 50% 0 0;transform:perspective(450px) rotateX(43deg)}.bk-road:after{content:"";position:absolute;left:50%;top:0;height:100%;border-left:6px dashed rgba(255,255,255,.82)}.bk-bike-photo{position:absolute;z-index:6;left:7%;bottom:1%;width:205px;height:150px;overflow:hidden;filter:drop-shadow(0 16px 12px rgba(20,30,20,.28));transform:rotate(-2deg);border-radius:20px}.bk-bike-photo img{width:100%;height:100%;object-fit:cover;object-position:center;display:block}.bk-bike-photo.fallback{background:linear-gradient(135deg,#24382b,#78966f)}.bk-bike-photo.fallback:after{content:"🏍️";display:grid;place-items:center;height:100%;font-size:78px}
      .bk-road-sign{position:absolute;z-index:12;right:1%;bottom:8%;background:#15523c;color:#fff;border-radius:7px;padding:11px 16px;font-size:12px;font-weight:900;box-shadow:0 12px 24px rgba(20,40,25,.2)}.bk-road-sign span{display:block;color:#bce995;font-size:8px;margin-top:3px}
      ...
      @media(max-width:700px){.bk-intercity-hero .bk-hero-grid{padding:34px 5% 0}.bk-intercity-hero h1{font-size:54px;letter-spacing:-3px}.bk-intercity-hero .lead{font-size:17px}.bk-hero-search{grid-template-columns:1fr 32px 1fr;gap:0}.bk-hero-search .bk-search-btn{grid-column:1/-1;margin-top:6px}.bk-hero-benefits{gap:8px;justify-content:space-between}.bk-hero-benefits div{min-width:0}.bk-hero-tagline{font-size:21px}.bk-landmark-map{height:650px;min-height:650px;margin:0 -5%;border-radius:0}.bk-landmark-card{width:140px}.bk-landmark-img{height:72px}.bk-landmark-card.hyd{top:13%;left:21%}.bk-landmark-card.viz{top:40%;left:3%}.bk-landmark-card.vij{top:29%;right:3%}.bk-landmark-card.tir{top:60%;right:5%}.bk-landmark-card.bng{top:68%;left:22%}.bk-map-title{font-size:22px;right:4%;top:3%;z-index:12}.bk-bike-photo{width:125px;height:95px;left:2%;bottom:2%}.bk-road-sign{font-size:9px;right:3%;bottom:7%}}
    `;
      ...
      <div class="bk-mainhero bk-intercity-hero">
        ...
        <div class="bk-hero-grid">
          ...
          <div class="bk-landmark-map" aria-label="BIKUBOO intercity destinations">
            ...
            <svg class="bk-city-route" viewBox="0 0 1000 620" preserveAspectRatio="none" aria-hidden="true">
              <path class="bk-route-shadow" d="M280 145 C250 190 205 220 150 280 C220 330 305 300 410 245 C520 185 620 205 735 265 C820 310 790 365 690 410 C600 450 535 505 430 500"/>
              <path class="bk-route-line-main" d="M280 145 C250 190 205 220 150 280 C220 330 305 300 410 245 C520 185 620 205 735 265 C820 310 790 365 690 410 C600 450 535 505 430 500"/>
              <circle cx="280" cy="145" r="8"/><circle cx="150" cy="280" r="8"/><circle cx="735" cy="265" r="8"/><circle cx="690" cy="410" r="8"/><circle cx="430" cy="500" r="8"/>
            </svg>
            <div class="bk-map-title">Explore Together<br><span>Across Cities</span></div>

            <article class="bk-landmark-card hyd"><img class="bk-landmark-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/Charminar-Hyderabad.jpg?width=900" alt="Charminar, Hyderabad" loading="eager"><div class="bk-landmark-label"><b>● Hyderabad</b><small>Charminar</small></div></article>
            <article class="bk-landmark-card viz"><img class="bk-landmark-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/R.K%20beach%40Vizag.jpg?width=900" alt="RK Beach, Visakhapatnam" loading="eager"><div class="bk-landmark-label"><b>● Visakhapatnam</b><small>RK Beach</small></div></article>
            <article class="bk-landmark-card vij"><img class="bk-landmark-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/PRAKASAM%20BARRAGE.jpg?width=900" alt="Prakasam Barrage, Vijayawada" loading="eager"><div class="bk-landmark-label"><b>● Vijayawada</b><small>Prakasam Barrage</small></div></article>
            ...
            <div class="bk-road-scene"><div class="bk-road"></div></div>
