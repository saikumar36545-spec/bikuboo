(function(){
  function init(){
    ...
    style.textContent=`
      ...
      .bk-landmark-map{position:relative;height:min(760px,calc(100vh - 80px));min-height:620px;overflow:hidden;display:grid;grid-template-columns:repeat(6,minmax(0,1fr));grid-template-rows:repeat(5,1fr);gap:14px;padding:70px 22px 24px}
      ...
      .bk-map-route{position:absolute;z-index:2;top:18%;left:40%;width:37%;height:54%;border-right:4px dashed #15241a;border-bottom:4px dashed #15241a;border-radius:0 0 65% 0;transform:rotate(-10deg)}
      .bk-map-node{position:absolute;z-index:4;width:17px;height:17px;border-radius:50%;background:#fff;border:5px solid #0b9850;box-shadow:0 0 0 6px rgba(11,152,80,.12)}.bk-map-node.n1{top:19%;left:43%}.bk-map-node.n2{top:32%;left:60%}.bk-map-node.n3{top:49%;left:57%}.bk-map-node.n4{top:65%;left:67%}
      ...
      .bk-landmark-card{position:relative;z-index:9;width:100%;max-width:190px;justify-self:center;align-self:center;border-radius:16px;background:#fff;box-shadow:0 13px 28px rgba(22,44,26,.15);overflow:hidden;border:2px solid rgba(255,255,255,.95);transition:transform .25s,box-shadow .25s}.bk-landmark-card:hover{transform:translateY(-6px) rotate(-1deg);box-shadow:0 20px 35px rgba(22,44,26,.2)}.bk-landmark-img{display:block;width:100%;height:104px;object-fit:cover;object-position:center}.bk-landmark-label{padding:8px 12px 10px}.bk-landmark-label b{display:block;color:#243128;font-size:12px}.bk-landmark-label small{display:block;color:#68746a;font-size:10px;margin-top:2px}.bk-landmark-card.hyd{grid-column:2 / span 2;grid-row:1 / span 2}.bk-landmark-card.viz{grid-column:1 / span 2;grid-row:3 / span 2}.bk-landmark-card.vij{grid-column:5 / span 2;grid-row:2 / span 2}.bk-landmark-card.tir{grid-column:4 / span 2;grid-row:4 / span 2}.bk-landmark-card.bng{grid-column:2 / span 2;grid-row:4 / span 2}
      .bk-road-scene{position:absolute;z-index:3;left:0;right:0;bottom:-3px;height:31%;overflow:hidden}.bk-road{position:absolute;left:-10%;right:-10%;bottom:-42%;height:90%;background:linear-gradient(180deg,#4d5d51,#27362b);border-radius:50% 50% 0 0;transform:perspective(450px) rotateX(43deg)}.bk-road:after{content:"";position:absolute;left:50%;top:0;height:100%;border-left:6px dashed #fff;opacity:.85}.bk-bike-photo{position:absolute;z-index:6;left:10%;bottom:1%;width:280px;height:230px;overflow:hidden;filter:drop-shadow(0 16px 12px rgba(20,30,20,.25));transform:rotate(-2deg)}.bk-bike-photo img{width:100%;height:100%;object-fit:cover;object-position:center 52%;display:block;border-radius:22px;mix-blend-mode:multiply}
      ...
      @media(max-width:700px){.bk-intercity-hero .bk-hero-grid{padding:34px 5% 0}.bk-intercity-hero h1{font-size:54px;letter-spacing:-3px}.bk-intercity-hero .lead{font-size:17px}.bk-hero-search{grid-template-columns:1fr 32px 1fr;gap:0}.bk-hero-search .bk-search-btn{grid-column:1/-1;margin-top:6px}.bk-hero-benefits{gap:8px;justify-content:space-between}.bk-hero-benefits div{min-width:0}.bk-hero-tagline{font-size:21px}.bk-landmark-map{height:650px;min-height:650px;margin:0 -5%;padding:72px 10px 16px;grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:repeat(6,1fr);gap:9px}.bk-landmark-card{width:100%;max-width:155px}.bk-landmark-img{height:78px}.bk-landmark-card.hyd{grid-column:1;grid-row:1 / span 2}.bk-landmark-card.vij{grid-column:2;grid-row:2 / span 2}.bk-landmark-card.viz{grid-column:1;grid-row:3 / span 2}.bk-landmark-card.tir{grid-column:2;grid-row:4 / span 2}.bk-landmark-card.bng{grid-column:1;grid-row:5 / span 2}.bk-map-title{font-size:22px;right:4%;top:3%;z-index:12}.bk-bike-photo{width:150px;height:125px;left:4%;bottom:2%}.bk-road-sign{font-size:9px;right:3%;bottom:7%}}
    `;
      ...
      <div class="bk-mainhero bk-intercity-hero">
        ...
        <div class="bk-hero-grid">
          ...
          <div class="bk-landmark-map" aria-label="BIKUBOO intercity destinations">
            ...
            <article class="bk-landmark-card hyd"><img class="bk-landmark-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/Charminar%20at%20Hyderabad%20Telangana%20India.jpg?width=900" alt="Charminar, Hyderabad" loading="eager"><div class="bk-landmark-label"><b>● Hyderabad</b><small>Charminar</small></div></article>
            <article class="bk-landmark-card viz"><img class="bk-landmark-img" src="https://www.ambicaseagreen.com/vizag/vizag.jpg" alt="RK Beach, Visakhapatnam" loading="lazy"><div class="bk-landmark-label"><b>● Visakhapatnam</b><small>RK Beach</small></div></article>
            <article class="bk-landmark-card vij"><img class="bk-landmark-img" src="https://assets.thehansindia.com/h-upload/2020/11/29/1015125-prakasam-barrage.webp" alt="Prakasam Barrage, Vijayawada" loading="lazy"><div class="bk-landmark-label"><b>● Vijayawada</b><small>Prakasam Barrage</small></div></article>
            <article class="bk-landmark-card tir"><img class="bk-landmark-img" src="https://upload.wikimedia.org/wikipedia/commons/d/d9/Tirumala_Venkateswara_temple_entrance_09062015.JPG" alt="Tirumala Temple, Tirupati" loading="lazy"><div class="bk-landmark-label"><b>● Tirupati</b><small>Tirumala Temple</small></div></article>
            <article class="bk-landmark-card bng"><img class="bk-landmark-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Vidhana_Soudha_close.jpg/1280px-Vidhana_Soudha_close.jpg" alt="Vidhana Soudha, Bengaluru" loading="lazy"><div class="bk-landmark-label"><b>● Bengaluru</b><small>Vidhana Soudha</small></div></article>

            <div class="bk-road-scene"><div class="bk-bike-photo"><img src="https://www.revzilla.com/blog_content_image/image/85604/gallery/2023_RE_SuperMeteor_JenDunstan_JS-37.JPG" alt="Motorcycle rider on highway" loading="eager"></div><div class="bk-road"></div></div>
