(function(){
  function init(){
    ...
    style.textContent=`
      ...
      .bk-city-route{position:absolute;z-index:3;inset:0;width:100%;height:100%;pointer-events:none;overflow:visible}
        ...
        <div class="bk-hero-grid">
          ...
          <div class="bk-landmark-map" aria-label="BIKUBOO intercity destinations">
            ...
            <svg class="bk-city-route" viewBox="0 0 1000 620" preserveAspectRatio="none" aria-hidden="true">
              <path class="bk-route-shadow" d="M280 145 C390 130 430 185 505 215 C590 248 650 205 760 235 C850 260 770 330 690 365 C610 400 540 450 430 470 C320 490 245 440 185 365"/>
              <path class="bk-route-line-main" d="M280 145 C390 130 430 185 505 215 C590 248 650 205 760 235 C850 260 770 330 690 365 C610 400 540 450 430 470 C320 490 245 440 185 365"/>
              <circle cx="280" cy="145" r="8"/><circle cx="505" cy="215" r="8"/><circle cx="760" cy="235" r="8"/><circle cx="690" cy="365" r="8"/><circle cx="430" cy="470" r="8"/>
            </svg>
            <div class="bk-map-title">Explore Together<br><span>Across Cities</span></div>

            <article class="bk-landmark-card hyd"><img class="bk-landmark-img" src="https://commons.wikimedia.org/wiki/Special:FilePath/Charminar%2C%20Hyderabad%2C%20India.jpg?width=900" alt="Charminar, Hyderabad" loading="eager"><div class="bk-landmark-label"><b>● Hyderabad</b><small>Charminar</small></div></article>
